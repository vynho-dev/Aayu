...
export function Select({label, options=[], value, onChange, placeholder='Select…'}) {
  ...
  return React.createElement('div', {style:{display:'flex', flexDirection:'column', gap:6, fontFamily:'var(--font-sans)'}},
    ...
    React.createElement('div', {style:{position:'relative'}},
      ...
      React.createElement('i', {'data-lucide':'chevron-down', 'aria-hidden':'true', style:{position:'absolute', right:14, top:'50%', transform:'translateY(-50%)', width:18, height:18, color:'var(--aayu-text-muted)', pointerEvents:'none'}})
    )
  );
}
