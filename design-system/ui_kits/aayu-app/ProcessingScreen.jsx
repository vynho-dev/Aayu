...
function ProcessingScreen() {
  ...
  return (
    <div role="status" aria-live="polite" style={{minHeight:520, background:'var(--aayu-surface-page)', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:16, padding:20}}>
      <div style={{width:56, height:56, borderRadius:'50%', border:'3px solid var(--aayu-teal-100)', borderTopColor:'var(--aayu-teal-600)', animation:'spin 1s linear infinite'}} aria-hidden="true"></div>
